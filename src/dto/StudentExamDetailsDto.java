...
public class StudentExamDetailsDto {
	...
	public StudentExamDetailsDto() {
		super();
		// TODO Auto-generated constructor stub
	}
	
	
	public StudentExamDetailsDto(String phone, String name, String email,
			String password, String address, String gender, Date dob,
			int attempt, int score_apti, int score_eng, int score_lr,
			int total_score, String status, String batch) {
		super();
		this.phone = phone;
		this.name = name;
		this.email = email;
	...
	public String toString() {
		return "StudentExamDetailsDto [phone=" + phone + ", name=" + name
